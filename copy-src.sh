...
cp -R ../akka/akka-docs/src/test/java/jdocs/tutorial_1/* src/test/java/com/lightbend/akka/sample/
cp -R ../akka/akka-docs/src/test/java/jdocs/tutorial_2/* src/test/java/com/lightbend/akka/sample/
cp -R ../akka/akka-docs/src/test/java/jdocs/tutorial_3 src/test/java/jdocs/
cp -R ../akka/akka-docs/src/test/java/jdocs/tutorial_4 src/test/java/jdocs/
cp -R ../akka/akka-docs/src/test/java/jdocs/tutorial_5 src/test/java/jdocs/
cp -R ../akka/akka-docs/src/test/java/jdocs/AbstractJavaTest.java src/test/java/jdocs/
cp -R ../akka/akka-docs/src/test/java/jdocs/stream src/test/java/jdocs/
